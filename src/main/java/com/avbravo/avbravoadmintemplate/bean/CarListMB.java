package com.avbravo.avbravoadmintemplate.bean;

import com.avbravo.avbravoadmintemplate.infra.model.Filter;
import com.avbravo.avbravoadmintemplate.model.Car;
import com.avbravo.avbravoadmintemplate.services.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.avbravo.avbravoadmintemplate.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.avbravo.avbravoadmintemplate.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.avbravo.avbravoadmintemplate.infra.model.SortOrder.DESCENDING
                            : com.avbravo.avbravoadmintemplate.infra.model.SortOrder.UNSORTED;
                }
